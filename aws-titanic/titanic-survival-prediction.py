...
emr_create_cluster_op     = components.load_component_from_file('emr/create_cluster/component.yaml')
emr_submit_spark_job_op = components.load_component_from_file('emr/submit_spark_job/component.yaml')
emr_delete_cluster_op     = components.load_component_from_file('emr/delete_cluster/component.yaml')
